...
async def main() -> None:
    ...
    regions_distribution_resolved = await wordstat.get_regions_distribution(
        search_query,
        # NB: resolve_regions=True is making extra request to get_regions_tree method
        resolve_regions=True,
        distribution_type='cities'
    )
    regions_distribution_unresolved = await wordstat.get_regions_distribution(
        search_query,
    ...
    regions_distribution = await wordstat.get_regions_distribution(
        search_query,
        resolve_regions=True,
