    ...
    def configure(  # type: ignore[override]
        ...
        *,
        ...
        :param reasoning_mode: the mode of reasoning to apply during generation, allowing the model to perform internal reasoning before responding.
            ...
            `reasoning documentation <https://aistudio.yandex.ru/docs/en/ai-studio/text-generation/api-ref/TextGeneration/completion#yandex.cloud.ai.foundation_models.v1.ReasoningOptions>`_.
        :param response_format: a format of the response returned by the model. Could be a JsonSchema, a JSON string, or a pydantic model.
            ...
            `structured output documentation_BaseGPTModel_URL <https://aistudio.yandex.ru/docs/en/ai-studio/concepts/generation/structured-output>`_.
    ...
    async def run(
        ...
        *,
        ...
        :param messages: the input messages to process. Could be a string, a dictionary, or a result object.
            ...
            `corresponding documentation <https://aistudio.yandex.ru/docs/en/ai-studio/sdk/#usage>`_.
