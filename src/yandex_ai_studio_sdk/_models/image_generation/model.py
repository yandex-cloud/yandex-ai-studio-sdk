    ...
    def configure(  # type: ignore[override]
        ...
        *,
        ...
        :param mime_type: the MIME type of the generated image.
            Read more on what MIME types exist in `the documentation <https://aistudio.yandex.ru/docs/en/ai-studio/image-generation/api-ref/ImageGenerationAsync/generate>`_.
        """
